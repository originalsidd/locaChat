...
function getLocation() {
 ...
 export const ChatRoom = () => {
    ...
    const messagesRef = firebase.firestore().collection('chatrooms').doc(id).collection('messages');
    let messagesRef1 = firestore.collection('chatrooms').doc(id).collection('messages');
